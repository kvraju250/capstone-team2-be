...
router.get("/", validateJwtMiddleware, appointmentController.getAppointments)

// this is get route to retuan all job requests by user email
router.get("/:id", validateJwtMiddleware, appointmentController.getAppointmentsById)
...
router.delete("/:id", validateJwtMiddleware, appointmentController.deleteAppointment)
